...
public class Loan extends Model {
    ...
    public static void createTable() throws SQLException {
        String tableSQL = "CREATE TABLE APP.LOANS(ID INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),USER_ID INTEGER NOT NULL,BOOK_ID INTEGER NOT NULL,BORROW_DATE DATE NOT NULL,RETURN_DATE DATE NOT NULL,DEADLINE_DATE DATE NOT NULL)";
